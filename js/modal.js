    ...
    const members = [
        {
            ...
            description: 'Віталій є засновником юридичної фірми Gangsters Group. Входить до складу Ради адвокатів міста Києва, є членом Київської торгово-промислової палати (Комітет з безпеки ведення бізнесу).Спеціалізація: створення бізнесу та побудова корпоративної структури в Україні та інших юрисдикціях; Допомога в управлінні бізнесом, проектами та активами;Розробка всіх видів корпоративних документів, у тому числі корпоративних договорів між учасниками та партнерських угод;Відкриття та ліквідація представництв іноземних компаній. Освіта: факультет юстиції, Національний юридичний університет імені Ярослава Мудрого(2010р.)',
        },
        {
            name: "ЄВГЕН КОСМОНАВТ",
            position: "Адвокат з інтелектуальної власності та захисту торгових марок",
            imageSrc: './images/team/2-1.jpg',
            description: 'Євген входить до складу Ради адвокатів міста Києва, є членом Київської торгово-промислової палати (Комітет з безпеки ведення бізнесу).Спеціалізація: надання юридичних консультацій щодо товарних знаків, авторського права, конфіденційності та трудового права. Євген займається проектами, починаючи від реєстрації та вирішення спорів у галузі інтелектуальної власності, ліцензійних угод та угод про програмне забезпечення, закінчуючи трудовими договорами та дотриманням законодавства. Євген отримав ступінь магістра. Освіта: факультет юстиції, Національний юридичний університет імені Ярослава Мудрого(2010р.)',
        },
        {
            name: "РУСЛАН ТАНК",
    ...
    const services = [
        {
            ...
            description1: 'Gangsters Group протягом майже 10 років на ринку надання юридичних, будуючи міцні відносини та унікальні знання ринку, які можуть допомогти підприємствам безперебійно здійснювати свою діяльність у регіоні.  Великий досвід компанії у цій галузі та його прагнення допомогти своїм клієнтам досягти успіху роблять його надійним партнером і порадником для будь-якого бізнесу.',
